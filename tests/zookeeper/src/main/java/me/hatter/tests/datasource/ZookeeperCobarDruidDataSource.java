...
public class ZookeeperCobarDruidDataSource extends MultiDataSource {
    ...
    public ZookeeperCobarDruidDataSource() {
    ...
    protected void initInternal() throws SQLException {
        ...
        if (ZookeeperCobarConfigLoader.isCobar(url)) {
            if (this.getConfigLoader() == null) {
                this.setConfigLoader(new ZookeeperCobarConfigLoader(this));
            }
            ...
            throw new RuntimeException("URL syntax error: " + url);
        }
    }
