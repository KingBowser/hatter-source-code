/*
 * cn.aprilsoft.jsapp.encode.secure.SHA256.js
 * jsapp, sha256 functions
 * 
...
function str_sha256(s){return binb2str(core_sha256(str2binb(s),s.length * chrsz));}
  ...
  var Hash = Using("cn.aprilsoft.jsapp.encode.secure.Hash");

  Class("cn.aprilsoft.jsapp.encode.secure.SHA256", Extend(), Implement(Hash),
  {
    hash: function(value)
    {
      return core_sha256(value);
    }
  });
})();
