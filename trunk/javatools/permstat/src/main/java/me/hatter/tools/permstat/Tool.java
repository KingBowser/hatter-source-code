/*
 * Copyright (c) 2002, 2004, Oracle and/or its affiliates. All rights reserved. DO NOT ALTER OR REMOVE COPYRIGHT NOTICES
...
public abstract class Tool implements Runnable {
    ...
    /*
     * Derived class main should be of the following form: public static void main(String[] args) { <derived class> obj
     * = new <derived class>; obj.start(args); }
     */
    ...
    protected void start(String[] args, PrintStream err) {
        ...
        try {
            switch (debugeeType) {
                ...
                case DEBUGEE_CORE:
                    err.println("Attaching to core " + coreFileName + " from executable " + executableName
                                + ", please wait...");
